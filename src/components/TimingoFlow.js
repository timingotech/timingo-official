        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16 animate-on-scroll">
            ...
            <p className="text-xl text-gray-600">
              Here's what the system looks like in real use — from finding leads to sending outreach.
            </p>
          </div>
          ...
          <div className="space-y-16">
            ...
            <div className="animate-on-scroll">
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-gray-700 max-w-3xl mx-auto leading-relaxed">
                  Search for marketing agencies in Atlanta and watch leads appear instantly. The system identifies businesses, 
                  extracts contact details, and shows results as they come in (49/50 leads found).
                </p>
              </div>
            </div>
            ...
            <div className="animate-on-scroll">
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-gray-700 max-w-3xl mx-auto leading-relaxed">
                  Review and send personalized emails to multiple leads at once. Messages are tailored for each business 
                  and ready to convert into replies and bookings.
                </p>
              </div>
            </div>
          </div>
